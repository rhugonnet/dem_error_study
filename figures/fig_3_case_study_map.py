...
legendax = fig.add_axes([0, 0.025, 0.2, 0.2], label='legends')
...
legendax = fig.add_axes([0.575, 0.025, 0.2, 0.2], label='legends3')
...
legendax = fig.add_axes([0.3, 0.025, 0.2, 0.2], label='legends2')
...
ax.text(plt_extent0[0]+500, plt_extent0[3]-500,
        'Fig. 4d', ha='left', va='top', bbox=dict(edgecolor='black', facecolor='white', alpha=1), zorder=5)
...
ax.add_patch(mpatches.Rectangle((plt_extent[0], plt_extent[2]), plt_extent[1] - plt_extent[0], plt_extent[3] - plt_extent[2],
                                edgecolor='black',facecolor='none',transform=ccrs.UTM(32),zorder=10,linewidth=2, linestyle='dashed'))
ax.text(plt_extent[1]-500, plt_extent[3]-500, 'Fig. 5b', ha='right', va='top', bbox=dict(edgecolor='black', facecolor='white', alpha=1), zorder=5)
...
ax.add_patch(mpatches.Rectangle((crop_ext[0], crop_ext[1]), crop_ext[2] - crop_ext[0], crop_ext[3] - crop_ext[1],
                                edgecolor='black',facecolor='none',transform=ccrs.UTM(32),zorder=10,linewidth=2, linestyle='dashed'))
ax.text(crop_ext[2]+500, crop_ext[3]-500, 'Fig. 6a', ha='left', va='top', bbox=dict(edgecolor='black', facecolor='white', alpha=1), zorder=5)
...
for rgiid in rgiid_gla:
    ...
    ax.text(xx + shift_xx[rgiid_gla.index(rgiid)], yy + shift_yy[rgiid_gla.index(rgiid)], names_gla[rgiid_gla.index(rgiid)], va='center', ha='center', color='darkblue', zorder=30, fontweight='bold')
