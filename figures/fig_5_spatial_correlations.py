...
for k in [1,0,2,3]:
    ...
    if k == 0:
        ax0.text(0.1, 0.9, 'a', transform=ax0.transAxes, ha='left', va='top', fontweight='bold', fontsize=14)
...
ax1.set_yticks([])
ax1.set_xlabel('Circular averaging area (km²)')
...
axcirc = ax1.inset_axes([-0.175, -0.6, 0.15, 2.6], zorder=10)
axcirc.set_xticks([])
axcirc.set_yticks([])
...
ax.annotate(text='', xy=(x, y2), xytext=(x, y1), arrowprops=dict(arrowstyle='-|>', connectionstyle=None,
                             shrinkA=0, shrinkB=0,
                             patchA=None, patchB=None, linewidth=1, facecolor='black'))
ax.text(x/20, y1, '{:.0f} %\nlarger error\nfor {:.1f} km²'.format(r, x), ha='center', va='center',
...
ax.annotate(text='', xy=(x, y2), xytext=(x, y1), arrowprops=dict(arrowstyle='-|>', connectionstyle=None,
                             shrinkA=0, shrinkB=0,
                             patchA=None, patchB=None, linewidth=1, facecolor='black'))
ax.text(x/20, y1, '{:.0f} %\nlarger error\nfor {:.0f} km²'.format(r, x), ha='center', va='center',
        bbox=dict(facecolor='white', boxstyle='round', alpha=0.8, linewidth=0.5))
...
ax.text(0.05, 0.99, 'c', transform=ax.transAxes, ha='left', va='top',fontweight='bold',fontsize=14)
...
ax = fig.add_subplot(grid[16:, :xgridmax[-1]-12], projection=ccrs.UTM(32), label='Mont-Blanc')
...
# Save to file
plt.savefig('/home/atom/ongoing/work_stderr_dem/figures/final/Figure_5_final.png', dpi=400)
